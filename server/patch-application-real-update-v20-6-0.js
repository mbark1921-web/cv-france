...
// Older builds emitted literal backslash-n sequences inside this script. Repair
// that block even when its marker already exists; do not touch other scripts.
html=html.replace(/<script>\/\* APPLICATION_REAL_UPDATE_V20_6_0 \*\/[\s\S]*?<\/script>/g,
  block=>block.replace(/\\n/g,'\n'));
